<?php
    ...
    if(isset($_SESSION["username"])){
        ...
        if(isset($_POST['titulo']) && isset($_POST['Descripcion']) ){
            ...
            $biblioteca = $_SESSION['IDbiblioteca'];
                /* Insertar en la base de datos */
                $sentenciaSQL = "INSERT INTO TABLA_SECCIONES(titulo, descripcion, numeroRecursos, bibliotecaTitulo) VALUES ('$titulo' , '$descripcion' , '$numeroRecusos' , '$biblioteca');"; 
            /* Si no falla la colsuta reedirigimos a la pagina de la base de datos */ 
            if(mysqli_query($conexion,$sentenciaSQL)){
                /* Cierro conexion */
                mysqli_close($conexion);
                /* Mesnaje al usuario */
                $mensaje = "Seccion añadida satifatoriamente";
                ...
                echo "<script> alert ('$mensaje') </script>";
                /* Redireccion a la plagina principal */
                header("Location: ./altaSeccion.php");
            } 
