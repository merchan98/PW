<?php
    ...
    $resultados = mysqli_query($conexion, $setenciaSQL3);
    /* Abrimos otra consexion para cada partado */
    ...
    echo '
        ...
        <head>
            <meta charset="UTF-8"/>
            <title>Borrar Seccion .-Base de datos multimedia</title>
        ...
        ?>
            ...
            <?php
            echo '
                <section id="Centro" class="seccion">
                <h1>Seleccionar Seccion</h1>';
                    /* Compruebo si hay recursos */
                    if(mysqli_num_rows($resultados) > 0){/* Hay recursos */
                        echo '  <form name="FormularioBorrarSeccion" action="TratarSelecionarSeccion.php" method="POST" >
